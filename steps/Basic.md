...
```
Шаг выполняет несколько итераций: нажимает на кнопку View в Toolbar, выбирает в выпадающем списке пункт Save As, вводит название новой вьюхи и нажимает на кнопку OK
